...
public class ReimpresaoCupom implements Parcelable {
    ...
    public ReimpresaoCupom() {

    }


    protected ReimpresaoCupom(Parcel in) {
        tr_id = in.readString();
        ...
        pds = in.readParcelable(PdReimpressao.class.getClassLoader());
        chave = in.readString();
    ...
    public static final Creator<ReimpresaoCupom> CREATOR = new Creator<ReimpresaoCupom>() {
        @Override
        public ReimpresaoCupom createFromParcel(Parcel in) {
            return new ReimpresaoCupom(in);
        }

        @Override
        public ReimpresaoCupom[] newArray(int size) {
            return new ReimpresaoCupom[size];
        }
    };
    ...
    public PdReimpressao getPds() {
        return pds;
    }

    public void setPds(PdReimpressao pds) {
        this.pds = pds;
    }
