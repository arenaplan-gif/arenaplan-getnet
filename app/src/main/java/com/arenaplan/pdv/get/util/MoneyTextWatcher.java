...
public class MoneyTextWatcher implements TextWatcher {
    ...
    public void afterTextChanged(Editable editable) {
        ...
        //NumberFormat format = getInstance(new Locale("pt", "BR"));
        //String formatted = NumberFormat.format.parse(parsed);
    ...
    public static String formatTextPrice(String price) {
        ...
        String newFormat = String.valueOf(getCurrencyInstance(Locale.getDefault()).format(bD));
    ...
    public static String getCurrencySymbol() {
        //NumberFormat brasil = NumberFormat.getCurrencyInstance(Locale..FRANCE);
        //NumberFormat format = NumberFormat.getInstance(new Locale("pt", "BR"));

        return getCurrencyInstance(Locale.getDefault()).getCurrency().getSymbol();
